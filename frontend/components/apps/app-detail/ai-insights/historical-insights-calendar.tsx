...
const getScoreHoverColor = (score: number | null) => {
  ...
  if (score === null) return "hover:bg-muted/80"
      ...
      <TooltipProvider>
        <div className="flex flex-wrap gap-1.5">
          {data.map((entry, index) => {
            ...
            const scoreForColor =
              hasInsight && entry.score === null ? -1 : entry.score
            ...
            return (
              <Tooltip key={index}>
                ...
                <TooltipContent
                  side="top"
                  className="border-border/70 bg-popover p-3 text-popover-foreground shadow-md"
                >
                      ...
                      <>
                        ...
                        {entry.anomalies > 0 && (
                          <div className="flex items-center gap-2 text-xs text-red-600 dark:text-red-300">
                            ...
                            {entry.anomalies} anomal
                            {entry.anomalies === 1 ? "y" : "ies"} detected
                          </div>
                        )}
                      </>
                    ) : (
