...
export function MetricsRow() {
  ...
  } = useApi(() => dashboardApi.getKeyMetrics(apiParams), {
    enabled: true,
    cacheKey,
  });
          ...
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-lg font-bold sm:text-2xl lg:text-3xl">
                  {metric.value}
                </p>
              ...
              <div className="hidden h-12 w-20 shrink-0 sm:block">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={metric.sparklineData}>
                    <defs>
                      <linearGradient
                        id={`gradient-${metric.title.replace(/\s+/g, "-")}`}
                        x1="0"
                        y1="0"
                        x2="0"
                        y2="1"
