...
export function RecentActivities() {
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="pt-0">
        {activities.length === 0 ? (
          <div className="text-center text-sm  py-8">No recent activities</div>
        ) : (
          <>
            <div className="space-y-3">
              {activities.map((activity) => {
                const {
                  ...
                  color,
                  bgColor,
                } = getActivityConfig(activity.type, activity.severity);
                ...
                return (
                  <Link
                    key={activity.id}
                    href={activity.resourceUrl || "/activity-logs"}
                    className="block"
                  >
                    {activityItem}
                  </Link>
