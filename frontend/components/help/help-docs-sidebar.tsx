  ...
  return (
    <>
      <aside
        ...
        onDrop={onDropAside}
        className={cn(
          "w-full shrink-0 lg:w-60 flex flex-col rounded-lg border bg-card shadow-sm transition-colors",
      ...
      >
        <div className="h-14 flex items-center gap-2 px-4 border-b border-border">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-foreground truncate">Help &amp; Docs</p>
            <p className="text-xs text-muted-foreground truncate">Tài liệu sản phẩm</p>
          </div>
        </div>
        ...
        <nav className="flex-1 p-2 space-y-1 overflow-y-auto min-h-0">
          <div>
            <button
              ...
              className={cn(
                ...
                anyChildActive ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-accent hover:text-accent-foreground",
              )}
            >
              <Bell className="w-5 h-5 flex-shrink-0" />
              <span className="flex-1 text-left">Alert Center</span>
              <ChevronRight
                className={cn("w-4 h-4 text-muted-foreground transition-transform shrink-0", alertCenterOpen && "rotate-90")}
              />
            </button>
          ...
          <div className="pt-2 mt-2 border-t border-border">
            ...
            >
              ...
              <ChevronRight
                className={cn("w-4 h-4 text-muted-foreground transition-transform shrink-0", uploadsOpen && "rotate-90")}
              />
            </button>
            ...
            {uploadsOpen && (
              <div className="mt-2 space-y-2 px-1">
                ...
                >
                  ...
                  <span className="text-[10px] text-muted-foreground leading-tight">{HELP_UPLOAD_ACCEPT_HINT}</span>
                </button>
                ...
                {docsLoading ? (
                  ...
                  <p className="text-[11px] text-muted-foreground px-2 text-center">Chưa có tài liệu.</p>
                ) : (
