...
const otherRegulatedCountryCodes = new Set<RegulatedCountryKey>(["AU", "IN", "TH", "BR"])
...
function getAdTransparencyCategories(form: RequestFormState, countryGroups: GeoCountryGroupDto[]): typeof transparencyCategories {
  ...
  if (form.geoMode === "GLOBAL") {
    return transparencyCategories.filter((category) => {
      if (category.key === "OTHER") return [...otherRegulatedCountryCodes].some((country) => !excluded.has(country))
  ...
  return transparencyCategories.filter((category) => {
    if (category.key === "OTHER") return [...otherRegulatedCountryCodes].some((country) => targeted.has(country))
...
function getRequiredAdTransparencyCategoryKeys(form: RequestFormState): Set<TransparencyCategoryKey> {
  ...
  if ([...otherRegulatedCountryCodes].some((country) => targeted.has(country))) required.add("OTHER")
  return required
}
