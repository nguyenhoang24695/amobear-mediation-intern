      ...
      <div className={`flex flex-wrap items-center gap-2 ${align === "right" ? "justify-end" : "justify-start"}`}>
        ...
        {onThumbnailLibrarySelect ? (
          <Button
            ...
            className="h-8 text-xs"
            disabled={thumbnailUploading}
            onClick={() => setThumbnailLibraryOpen(true)}
          >
            From Library
          </Button>
        ) : null}
    ...
    <div className="space-y-2 rounded-lg border border-slate-200 bg-slate-50 p-3">
      ...
      {onThumbnailLibrarySelect ? (
        <NexusAssetLibraryDialog
          ...
          targetKind="image"
          selectedAssetId={thumbnailSelection?.uploadedAssetId}
          onSelect={onThumbnailLibrarySelect}
        />
      ) : null}
