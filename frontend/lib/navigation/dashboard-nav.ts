...
export const MOBILE_MORE_NAV_ITEMS: MobileMoreNavItem[] = [
  ...
  { label: "Monitoring", href: "/monitoring/admob", matchPrefixes: ["/monitoring"] },
  { label: "Activity", href: "/activity-logs", matchPrefixes: ["/activity-logs"] },
  { label: "Meta Ads", href: "/meta-ads/campaigns", matchPrefixes: ["/meta-ads"] },
  { label: "TikTok Ads", href: "/tiktok-ads/campaigns", matchPrefixes: ["/tiktok-ads"] },
  { label: "AI Assistant", href: "/ai-assistant", matchPrefixes: ["/ai-assistant", "/ai-hub", "/agent-admin"] },
  ...
  { label: "WF Config", href: "/waterfall-rules", matchPrefixes: ["/waterfall-rules", "/waterfall-apply"] },
